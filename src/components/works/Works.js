...
import { NavLink, Switch, Link, useParams, withRouter,Route } from 'react-router-dom';
                    ...
                    <div className='main-text'>
                        ...
                        <div ref={this.textWrapper} className="text-container-works">
                            ...
                            <div className='all-works'>
                                ...
                                <Link onClick={()=> this.handleWork()} className="no-dec" to={`${url}/reading-comprehension-tool`}>
                                    <div className="each-work">  
                                        <div className="work-text">
