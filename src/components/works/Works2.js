...
class Works extends Component {
  ...
  componentDidMount() {
    ...
    if (
      ...
      this.props.context.state.lastLocation.pathname === "/about"
    ) {
      // this.imageContainer.current.classList.add("set-up-profile");
      this.imageContainer.current.classList.add("set-up-profile-works");
    }
    var delay = 1000;
    setTimeout(() => {
      // animations
                  ...
                  >
                    <div className="each-work">
                      <div className="work-text">
                        ...
                        <p className="secondary-work-text">
                          Research, Structure, Interaction, Visual, User
                          Feedback
                        </p>
                      </div>
                      <div className="work-image-wrapper">
