              ...
              <div className="scrollable-container">
                <div className="about-details">
                  ...
                  <p className="p-over">
                    ...
                    <a
                      className="p-link"
                      href="https://en.wikipedia.org/wiki/Talmudic_law"
                      target="_blank"
                      rel="noreferrer"
                    >
                      Talmudic Law
                ...
                <div className="about-details">
                  ...
                  <p className="p-over">
                    ...
                    <a
                      className="p-link"
                      href="http://instagram.com/mayerseidman"
                      target="_blank"
                      rel="noreferrer"
                    >
                      traveling the world
                ...
                <div className="about-details">
                  ...
                  <p className="p-over links">
                    <a
                      className="mixcloud"
                      href="https://www.mixcloud.com/mayer-seidman/"
                      target="_blank"
                      rel="noreferrer"
                    >
                      Mixcloud
                    ...
                    <a
                      ...
                      href="https://www.pinterest.com/mayerseidman/projects/"
                      target="_blank"
                      rel="noreferrer"
                    >
                      Pinterest
                ...
                <div className="about-details">
                  ...
                  <p className="p-over links">
                    <a
                      className="long"
                      href="https://www.instagram.com/mayerseidman/"
                      target="_blank"
                      rel="noreferrer"
                    >
                      Instagram
                    ...
                    <a
                      className="linkedIn"
                      href="https://www.linkedin.com/in/mayer-seidman/"
                      target="_blank"
                      rel="noreferrer"
                    >
                      LinkedIn
    ...
    return (
      <div ref={this.prof} className="floating-profile-a">
        <div ref={this.imageContainer} className="profile-image-container">
          <img
            alt="profile"
            className="image-prof-a left"
            src={cooking}
            onLoad={this.handleImageLoaded}
          />
          <img
            alt="profile"
            className="image-prof-a"
            src={music}
            onLoad={this.handleImageLoaded}
          />
          <img
            alt="profile"
            className="image-prof-a left lower"
            src={drawing}
            onLoad={this.handleImageLoaded}
          />
          <img
            alt="profile"
            className="image-prof-a lower"
            src={hat}
            onLoad={this.handleImageLoaded}
          />
        </div>
